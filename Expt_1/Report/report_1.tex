...
\end{figure}
\noindent
From the plot, we can see that initially there was no change in the output voltage but at $V_{\mathrm{in}} = 10.5$, the output voltage increased rapidly. Thus, from the experimental plot, we can estimate the breakdown voltage of the given Zener diode to be:
